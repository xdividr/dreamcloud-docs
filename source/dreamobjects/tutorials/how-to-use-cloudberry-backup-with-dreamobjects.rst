...
.. figure:: images/cloudberry-backup/01_Cloudberry.fw.png

2. Select the 'Setup Backup Plan' option.

.. figure:: images/cloudberry-backup/02_Cloudberry.fw.png

3. Click the **Next** button.

.. figure:: images/cloudberry-backup/03_Cloudberry.fw.png

4. In the 'Select Cloud Storage' window, select the 'DreamObjects' option and
   then '<Create a new account>'.

.. figure:: images/cloudberry-backup/04_Cloudberry.fw.png
...
.. figure:: images/cloudberry-backup/06_Cloudberry.fw.png

7. Enter a backup 'Plan name'.

.. figure:: images/cloudberry-backup/07_Cloudberry.fw.png

8. Select a backup mode.

.. figure:: images/cloudberry-backup/08_Cloudberry.fw.png

9. Select whether you wish to use VSS (Volume Shadow Copy Service).

.. figure:: images/cloudberry-backup/09_Cloudberry.fw.png

10. Select the location of the files and folders you wish to backup.

.. figure:: images/cloudberry-backup/10_Cloudberry.fw.png
...
17. Confirm the settings on the summary page, and then click the **Next**
    ...
    *A confirmation page appears:*
    ...
    .. figure:: images/cloudberry-backup/17_Cloudberry.fw.png

    * You can run the backup now by checking the box, or you can click
      **Finish** to run it a later time.

    .. figure:: images/cloudberry-backup/18_Cloudberry.fw.png
